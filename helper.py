...
title_code = """
<span style="color:rgb(0, 191, 99); font-size:80px; font-weight:600">Crops </span>
<span style="font-size:80px; font-weight:600"> & </span>
<span style="color:rgb(12, 192, 223); font-size:80px; font-weight:600">Carbon</span><br>
...
<li>The dataset focuses on CO2 emissions related to the agri-food sector, comprising about 62% of global annual emissions.</li>
</ul>
"""
